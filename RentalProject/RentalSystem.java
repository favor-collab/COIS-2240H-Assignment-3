...
public class RentalSystem {
    ...
    public void addVehicle(Vehicle vehicle) {
        ...
        saveVehicle(vehicle); // save to file automatically
    ...
    public void displayVehicles(Vehicle.VehicleStatus status) {
        ...
        for (Vehicle v : vehicles) {
            if (status == null || v.getStatus() == status) {
                System.out.println(v); // assuming Vehicle.toString prints nicely
            }
        }
    }
    ...
    public void addCustomer(Customer customer) {
        ...
        saveCustomer(customer); // save to file automatically
        System.out.println("Customer added.");
    }

    public void displayAllCustomers() {
        for (Customer c : customers) {
            System.out.println(c); // assuming Customer.toString prints nicely
        }
    }
    ...
    public void rentVehicle(Vehicle vehicle, Customer customer, LocalDate date, double amount) {
        if (vehicle.getStatus() == Vehicle.VehicleStatus.Available) {
            ...
            saveRecord(record); // save rental record
    ...
    public void returnVehicle(Vehicle vehicle, Customer customer, LocalDate date, double extraFees) {
        if (vehicle.getStatus() == Vehicle.VehicleStatus.Rented) {
            ...
            rentalHistory.add(record);
            saveRecord(record); // save return record
    ...
    public void displayRentalHistory() {
        if (rentalHistory.isEmpty()) {
            ...
            for (RentalRecord r : rentalHistory) {
                System.out.println(r); // assuming RentalRecord.toString prints nicely
            }
        }
    }
